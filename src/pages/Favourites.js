  ...
  return (
    <main className="favourites-main">
      <section className="favourites-page">
        ...
        {favMovies.length > 0 ? (
          <Movies movies={favMovies} updateFavs={updateFavs} />
        ) : (
          <p className="no-favs">
            No movies have been added to your favourites. Please click on the
            heart icon in order to save your favourite movies here.
          </p>
        )}
      </section>
    </main>
